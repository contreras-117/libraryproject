    ...
    useEffect(() => {
        const fetchUserMessages = async () => {
            if (authState && authState?.isAuthenticated) {
                const url = `${process.env.REACT_APP_API}/messages/search/findByUserEmail?userEmail=${authState?.accessToken?.claims.sub}&
                ...
                if (!messagesResponse.ok) {
                    throw new Error('Failed to retrieve messages from backend API GET request');
                }
